...
TASKS = frozenset({"detect", "segment", "classify", "pose", "obb", "poseclass", "driverroi"})
TASK2DATA = {
    "detect": "coco8.yaml",
...
TASK2MODEL = {
    ...
    "obb": "yolo26n-obb.pt",
    "driverroi": "yolov8-driverroi.yaml",
}
TASK2METRIC = {
